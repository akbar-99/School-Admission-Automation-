// Country dial codes for the phone-number fields on the admission form.
// India is first (the most common default); the rest are alphabetical by name.
// `iso` is the ISO 3166-1 alpha-2 code, used to render the flag emoji.
